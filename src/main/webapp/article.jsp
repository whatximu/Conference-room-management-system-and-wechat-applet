            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="apply_tbl">
                    ...
                    <tr>
                        ...
                        <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span>
                            <span class="visible-lg">会议室名称
 <select class="selectpicker" onchange="selectOnchang(this)">
           <option value="0">所有</option>
           <option value="1">2B201</option>
           <option value="2">2B305</option>
           <option value="3">2B307</option>
           <option value="4">1C102</option>
           <option value="5">B316</option>
          <option value="6">A316</option>
           <option value="7">A312</option>
        </select>
                        </span>
                        </th>
...
<script>
    ...
    function to_page(pn,room) {
        $.ajax({
            url: "/getApplication",
            data: "pn=" + pn + "&room="+room,
            type: "GET",
