...
<%--        <input type="text" id="user_name" name="userName" class="form-control" placeholder="请输入用户名" required autofocus--%>
<%--               autocomplete="off" maxlength="10">--%>
<%--        <label for="user_Pwd" class="sr-only">密码</label>--%>
<%--        <input type="password" id="user_Pwd" name="passWord" class="form-control" placeholder="请输入密码" required--%>
<%--               autocomplete="off" maxlength="16">--%>
<%--        <button class="btn btn-lg btn-primary btn-block" type="button" id="signSubmit">登录</button>--%>
<%--    </form>--%>
    <div class="footer">
