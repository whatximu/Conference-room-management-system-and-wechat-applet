            ...
            <div class="modal-body">
                <form class="form-horizontal" id="roomUpdateForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static" id="roomId_update_static"></p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="roomName" class="form-control" id="roomName_update_input" placeholder="名称">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="state" id="state1_add_input" value="1"> 维护
                            </label>
                        </div>
                    </div>
                </form>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="apply_tbl">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">位置</span></th>
                            <th><span class="glyphicon glyphicon-list"></span> <span class="visible-lg">容纳人数</span></th>
...
<script>
    ...
    function getRoomById(id) {
        $.ajax({
            ...
            success:function (result) {
                ...
                $("#roomName_update_input").val(result.roomName);
                $("#location_update_input").val(result.location);
                $("#population_update_input").val(result.population);
                $("#device_update_input").val(result.device);
    ...
    $("#room_update_btn").click(function () {
        $.ajax({
            url:"/updateRoom/"+$(this).attr("edit-id"),
            type:"POST",
    ...
    $(document).on("click",".delete_btn",function(){
        //1、弹出是否确认删除对话框
        var roomName = $(this).parents("tr").find("td:eq(2)").text();
        var roomId = $(this).attr("del-id");
    ...
    //点击全部删除，就批量删除
    $("#room_delete_all_btn").click(function(){
        //
        var roomNames = "";
        var del_idstr = "";
        $.each($(".check_item:checked"),function(){
            //this
            roomNames += $(this).parents("tr").find("td:eq(2)").text()+",";
            //组装id字符串
        ...
        if(confirm("确认删除【"+roomNames+"】吗？")){
            //发送ajax请求删除
            $.ajax({
                url:"/deleteRoom/"+del_idstr,
                type:"POST",
                success:function(result){
                    to_page(currentPage);
                    if (result>0){
